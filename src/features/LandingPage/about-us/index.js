...
const descriptionsHeadlines = [
  "Für wen wurde HelpOnSpot entwickelt?",
  "Wer ist das Team hinter HelpOnSpot?\n",
];
    ...
    <div className="pt-24">
      <div className="container px-3 mx-auto flex flex-wrap items-center ">
        ...
        <div className="flex w-1/2 ">
          <p className="leading-normal text-figmaParagraph font-inter">
            HelpOnSpot ist eine praktische Lösung, um Menschen und Institutionen
            im Umgang mit Krisen zu helfen. Indem engagierte Hilfskräfte schnell
            und unkompliziert genau dorthin vermittelt werden, wo man
            Unterstützung braucht, wird personellen Versorgungsengpässen
            entgegengewirkt.
          </p>
        </div>
      </div>
      ...
      <div className="container px-3 mx-auto flex-col flex-wrap items-center ">
        <div className="mb-8 flex flex-row text-center flex-custom">
          <h1 className="my-4 w-1/2 text-lg leading-tight text-figmaHead font-dm-sans-h2 pr-3">
            {descriptionsHeadlines[0]}
          </h1>
          <h1
            className="my-4 w-1/2 text-lg leading-tight text-figmaHead font-dm-sans-h2"
            pl-3
          >
            {descriptionsHeadlines[1]}
          </h1>
        </div>

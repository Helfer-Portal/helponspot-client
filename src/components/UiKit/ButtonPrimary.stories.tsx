...
export const BlueWithIcon = () => (
  <ButtonPrimaryBlue icon={PlusIcon}>Hello</ButtonPrimaryBlue>
);
...
export const OrangeWithIcon = () => (
  <ButtonPrimaryOrange icon={PlusIcon}>Hello</ButtonPrimaryOrange>
);
